...
for i in $(seq $start $end); do
    ...
    # Clone the repository outside the GrantAlignTool directory
    echo "Cloning ${repo_name}..."
    git clone git@github.com:${github_username}/${repo_name}.git "${current_dir}/${repo_name}"
    if [ $? -ne 0 ]; then
